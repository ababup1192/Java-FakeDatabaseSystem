...
import org.ababup1192.fds.controllers.manipulate.executor.selector.UserChildSelector;
import org.ababup1192.fds.controllers.manipulate.executor.selector.UserSelector;
import org.ababup1192.fds.utils.Printer;

import java.util.Scanner;

public class SelectTypeSelector implements DBManipulateState {

    @Override
    public DBManipulateState execute() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("検索するデータタイプを選んでください。");
